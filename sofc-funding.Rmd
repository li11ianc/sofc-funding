...
prog_cat <- prog_cat %>%
  mutate(community = case_when(
    ...
    org %in% c("Students of the Caribbean Association",
              "Multicultural Greek Council", #preetha added
              "Minority Association of Premedical Students", #preetha added
              "The Bridge",
              "United in Praise",
              "International Association") ~ "Other BIPOC group",
    TRUE ~ "Nonspecific"
  ))
```
...
ggplot(prog_cat, aes(x = prop_grant)) +
  geom_histogram(aes(fill = factor(community, levels=c("Asian", "Black", "Indigenous", "Latinx", "Middle-Eastern", "Other BIPOC group", "Nonspecific"))),
